            ...
            <section className="bg-indigo-700 text-white py-16 px-6 text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <p className="text-lg md:text-xl text-gray-300">
                        Learn about the policies that guide the content, usage, and interactions on our blog.
                    </p>
                </div>
            </section>
            ...
            <section className="py-12 px-6">
                <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
                    ...
                    <p className="text-gray-700 mb-4">
                        By accessing and using our blog, you agree to comply with and be bound by these Terms
                    ...
                    <p className="text-gray-700 mb-4">
                        Our blog may include links to external websites for additional resources. We are not
